...
ACONT <- NULL
for(i in 1:repets){
  filename <- paste('output', name, n, p, toString(SNR), K, max.dim, mode, i, sep='_')
...
jpeg(filename=paste0("ARI_dim", max.dim, "_K", K, "_SNR(", toString(SNR), ")_p", p, "_n", n, "_rep", repets, "_mode_", smode, ".jpg"))
